...
/**
 * Backup RAM (BRAM) function codes
 * For use with the _BURAM vector defined above
...
/**
 * BIOS function codes
 * For use with the _CDBIOS vector defined above
 * Function ID should be placed in the d0 register
 */
